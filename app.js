...
window.setLang=function(lang){
  ...
  const t=T[lang];
  ["subtitle","nameTitle","nameText","enterBtn","playersTitle","rulesTitle","ruleTh","pointsTh","lockInfo","matchRankTitle","rankNameTh","rankPredTh","rankPtsTh","predTitle","predHelp","saveBtn"].forEach(id=>document.getElementById(id).textContent=t[id]);
...
function renderMatchRanking(){
  ...
  if(!res){ box.innerHTML=T[currentLang].winnerPending; }
    ...
    if(winners.length){
      ...
      box.innerHTML=T[currentLang].noPreds;
    }
  }
